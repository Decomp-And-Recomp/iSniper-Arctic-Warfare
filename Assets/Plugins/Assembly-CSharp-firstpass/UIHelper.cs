...
public class UIHelper : MonoBehaviour, UIHandler
{
	...
	public void Start()
	{
		...
		TextAsset textAsset = Resources.Load<TextAsset>(m_ui_cfgxml);
				...
				foreach (XmlNode childNode2 in childNode.ChildNodes)
				{
					...
					if ("UIButton" == childNode2.Name)
					{
						...
						if ("click" == empty)
						{
							...
							((UIClickButton)uIButtonBase).Rect = new Rect((float)(int.Parse(array[0].Trim()) * num) + rect.x, (float)(int.Parse(array[1].Trim()) * num) + rect.y, (float)(int.Parse(array[2].Trim()) * num) + rect.width, (float)(int.Parse(array[3].Trim()) * num) + rect.height);
						}
						else if ("press" == empty)
						{
							uIButtonBase = new UIPressButton();
							((UIPressButton)uIButtonBase).Rect = new Rect((float)(int.Parse(array[0].Trim()) * num) + rect.x, (float)(int.Parse(array[1].Trim()) * num) + rect.y, (float)(int.Parse(array[2].Trim()) * num) + rect.width, (float)(int.Parse(array[3].Trim()) * num) + rect.height);
						}
						else if ("push" == empty)
						{
						...
						if (xmlElement != null)
						{
							...
							uIButtonBase.SetTexture(UIButtonBase.State.Normal, LoadUIMaterial(empty), new Rect(int.Parse(array[0].Trim()) * num, int.Parse(array[1].Trim()) * num, int.Parse(array[2].Trim()) * num, int.Parse(array[3].Trim()) * num));
						}
						...
						if (xmlElement != null)
						{
							...
							uIButtonBase.SetTexture(UIButtonBase.State.Pressed, LoadUIMaterial(empty), new Rect(int.Parse(array[0].Trim()) * num, int.Parse(array[1].Trim()) * num, int.Parse(array[2].Trim()) * num, int.Parse(array[3].Trim()) * num));
						}
						...
						if (xmlElement != null)
						{
							...
							uIButtonBase.SetTexture(UIButtonBase.State.Disabled, LoadUIMaterial(empty), new Rect(int.Parse(array[0].Trim()) * num, int.Parse(array[1].Trim()) * num, int.Parse(array[2].Trim()) * num, int.Parse(array[3].Trim()) * num));
						}
					...
					else if ("UIImage" == childNode2.Name)
					{
						...
						empty = xmlElement.GetAttribute("rect").Trim();
						array2 = empty.Split(',');
						uIImage.Rect = new Rect((float)(int.Parse(array2[0].Trim()) * num) + rect2.x, (float)(int.Parse(array2[1].Trim()) * num) + rect2.y, (float)(int.Parse(array2[2].Trim()) * num) + rect2.width, (float)(int.Parse(array2[3].Trim()) * num) + rect2.height);
						empty = xmlElement.GetAttribute("enable").Trim();
						if (empty.Length > 0)
						{
						...
						if (xmlElement != null)
						{
							...
							uIImage.SetTexture(LoadUIMaterial(empty), texture_rect, size);
						}
					...
					else if ("UIText" == childNode2.Name)
					{
						...
						empty = xmlElement.GetAttribute("rect").Trim();
						array3 = empty.Split(',');
						uIText.Rect = new Rect((float)(int.Parse(array3[0].Trim()) * num) + rect3.x, (float)(int.Parse(array3[1].Trim()) * num) + rect3.y, (float)(int.Parse(array3[2].Trim()) * num) + rect3.width, (float)(int.Parse(array3[3].Trim()) * num) + rect3.height);
					...
					else if ("UINewMove" == childNode2.Name)
					{
						UINewMove uINewMove = new UINewMove();
						empty = xmlElement.GetAttribute("name").Trim();
						m_control_table.Add(empty, uINewMove);
						uINewMove.Id = num2;
						Rect rect6 = new Rect(0f, 0f, 0f, 0f);
						string[] array6;
						if (Utils.IsRetina())
						{
							empty = xmlElement.GetAttribute("adjustrect").Trim();
							...
							{
								array6 = empty.Split(',');
								rect6 = new Rect(int.Parse(array6[0].Trim()), int.Parse(array6[1].Trim()), int.Parse(array6[2].Trim()), int.Parse(array6[3].Trim()));
							}
						}
						empty = xmlElement.GetAttribute("rect").Trim();
						array6 = empty.Split(',');
						uINewMove.Rect = new Rect((float)(int.Parse(array6[0].Trim()) * num) + rect6.x, (float)(int.Parse(array6[1].Trim()) * num) + rect6.y, (float)(int.Parse(array6[2].Trim()) * num) + rect6.width, (float)(int.Parse(array6[3].Trim()) * num) + rect6.height);
						empty = xmlElement.GetAttribute("enable").Trim();
						if (empty.Length > 1)
						{
							uINewMove.Enable = "true" == empty;
						}
						m_UIManagerRef.Add(uINewMove);
					}
					num2++;
				}
			}
			else
			{
				...
				foreach (XmlNode childNode3 in childNode.ChildNodes)
				{
					...
					if (xmlElement != null)
					{
						...
						{
							array7 = empty.Split(',');
							uIAnimations.translate_offset.x = int.Parse(array7[0].Trim()) * num;
							uIAnimations.translate_offset.y = int.Parse(array7[1].Trim()) * num;
						}
	...
	public void LateUpdate()
	{
		foreach (UIAnimations value in m_animations.Values)
		{
			...
			{
				value.Update(Time.fixedDeltaTime);
			}
			else
			{
