public class GameCenterPlugin
{
	...
	public static bool SubmitAchievement(string category, int percent = 100)
	{
		return false;
	}

	public static SUBMIT_STATUS SubmitAchievementStatus(string category, int percent = 100)
	{
		return SUBMIT_STATUS.SUBMIT_STATUS_IDLE;
	}
